...
movefile('output',['output_pitchDecayCase_',num2str(mcr.cases(imcr,1),'%2g'),'deg'])
...
savefig(['output_pitchDecayCase_',num2str(mcr.cases(imcr,1),'%2g'),'deg/platformPitch.fig'])
