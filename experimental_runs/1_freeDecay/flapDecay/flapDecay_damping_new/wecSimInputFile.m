...
simu.explorer = 'on';
simu.domainSize = 2;
simu.CITime = 10;       %this is a numerical trick, CItime shouldnt be this long, check hydroData
...
%% Body 3: Platform
body(3) = bodyClass('../../../hydroData/Analysis_new.h5');                     
