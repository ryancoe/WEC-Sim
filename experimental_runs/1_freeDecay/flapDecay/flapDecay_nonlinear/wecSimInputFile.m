...
body(2).viscDrag.characteristicArea(5) = 0.0062;  %[m^2]
% Second Momoent Area - Iyy = w*h^3/12
% https://en.wikipedia.org/wiki/List_of_area_moments_of_inertia
...
body(3).mass = 153.8+6.6720;   %[kg] from Exp (no PVC)
...
body(3).viscDrag.cd(3) = 1.28;              % from heave decay
body(3).viscDrag.characteristicArea(3) = 1.22; %[m^2]  from heave decay
