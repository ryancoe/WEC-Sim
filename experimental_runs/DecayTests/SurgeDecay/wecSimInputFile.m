...
% body(1).initDisp.initLinDisp=[0.25,0,0];
...
% body(2).initDisp.initLinDisp=[0.25,0,0];
...
% body(3).initDisp.initLinDisp=[0.25,0,0];
...
rectangleFrame.initDisp.initLinDisp = [0.25 0 0];
...
constraint(1).mooring.initLinDispAngle = [0.25 0 0 0 0 0];

%% Constraint 2
constraint(2)= constraintClass('arm_surge');
constraint(2).loc = [0 0 -0.5];
constraint(2).mooring.initLinDispAngle = [0.25 0 0 0 0 0];
...
constraint(6).mooring.initLinDispAngle = [1 0 0 0 0 0];

%% PTO 2
constraint(7)= constraintClass('PTO_flap2');
constraint(7).loc = [ 0.65 0 -0.5];
constraint(7).mooring.initLinDispAngle = [1 0 0 0 0 0];
